...
function nowSize(val,initWidth=1242){
    return val * (nowClientWidth/initWidth)*77.625;
};
...
option = {
    ...
    geo: {
        ...
        roam: true, // 是否开启缩放
        zoom: 1.2, // 初始缩放大小
        center: [0.299633,-60.914039], // 地图中心点
        scaleLimit: {
            // 缩放等级
            min: 1,
            max: 10,
